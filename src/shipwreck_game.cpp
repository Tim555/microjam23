...
MJ_GAME_LIST_ADD(shipwreck::shipwreck_game)
...
shipwreck_game::shipwreck_game(int completed_games, const mj::game_data& data) :
...
void shipwreck_game::fade_in([[maybe_unused]] const mj::game_data& data)
{
}

mj::game_result shipwreck_game::play(const mj::game_data& data)
{
...
void shipwreck_game::fade_out([[maybe_unused]] const mj::game_data& data)
{
}
